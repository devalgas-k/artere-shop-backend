...
import com.artere.shop.catalogue.infrastructure.adapter.out.persistence.mapper.CategoryMapperImpl;
...
@Import({CategoryPersistenceAdapter.class, CategoryMapperImpl.class})
